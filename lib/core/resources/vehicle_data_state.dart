...
import '../../modules/map/data/models/resp_models/route_history_model.dart';
import '../../modules/vehincle/data/models/resp_models/route_history_model.dart';
...
Future<VehicleRespModel> handleVehicleErrorHandling(Future<VehicleRespModel> future) async {
  try {
    return await future;
...
Future<VehicleRouteHistoryRespModel> handleVehicleRouteHistoryError(Future<VehicleRouteHistoryRespModel> future) async {
  try {
    return await future;
  } on DioException catch (error) {
    if (error.type == DioExceptionType.connectionTimeout ||
