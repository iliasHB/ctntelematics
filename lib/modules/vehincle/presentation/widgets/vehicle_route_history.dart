...
class VehicleRouteHistory extends StatefulWidget {
  ...
  const VehicleRouteHistory(this.brand, this.model, this.vin, this.latitude,
      this.longitude, this.token,
      {super.key});

  @override
  State<VehicleRouteHistory> createState() => _VehicleRouteHistoryState();
}

class _VehicleRouteHistoryState extends State<VehicleRouteHistory> {
