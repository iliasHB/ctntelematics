...
//                   final speedLimit = double.tryParse(v.locationInfo.speedLimit?.toString() ?? '0') ?? 0;
//                   final vehicleSpeed = double.tryParse(v.locationInfo.tracker?.position?.speed?.toString() ?? '0') ?? 0;
