        ...
        return Align(
          ...
          child: Material(
            ...
            child: Container(
              ...
              constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.6), // Dynamic height
              width: 360,
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    BlocProvider(
                      create: (_) => sl<DashVehiclesBloc>()..add(DashVehicleEvent(dashVehicleReqEntity)),
...
class VehicleList extends StatelessWidget {
  ...
  const VehicleList(this.state, {super.key});
