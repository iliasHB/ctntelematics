...
class DashVehicleRespModel extends DashVehicleRespEntity {
  DashVehicleRespModel({
  ...
  factory DashVehicleRespModel.fromJson(Map<String, dynamic> json) =>
      DashVehicleRespModel(
        current_page: json["current_page"],
        data:
        // json["data"] is List<Map<String, dynamic>>
        //     ? List<Datum>.from(json["data"].map((x) => Datum.fromJson(x)))
        //     : null,
        (json['data'] as List).map((data) => Datum.fromJson(data)).toList(),
...
class Datum extends DashDatumEntity {
  Datum({
    required super.id,
...
class Driver extends DashDriverEntity {
  Driver({
    required super.id,
    required super.name,
...
class LastLocation extends DashLastLocationEntity {
  LastLocation({
    required super.vehicle_id,
...
class Owner extends DashOwnerEntity {
  Owner({
    required super.id,
...
class Tracker extends DashTrackerEntity {
  Tracker({
...
class Link extends DashLinkEntity {
  Link({
    required super.url,
