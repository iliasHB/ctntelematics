...
class DashVehicleRespEntity extends Equatable{
  int? current_page;
...
class DashDatumEntity extends Equatable{
  int? id;
  String? brand;
  String? model;
  String? year;
  ...
  String? created_at;
  String? updated_at;
  DashDriverEntity? driver;
  DashOwnerEntity? owner;
  DashTrackerEntity? tracker;
  DashLastLocationEntity? last_location;
...
class DashDriverEntity extends Equatable{
  int? id;
  String? name;
  String? email;
  String? phone;
...
class DashLastLocationEntity extends Equatable {
  int? vehicle_id;
  int? tracker_id;
  String? latitude;
  String? longitude;
...
class DashOwnerEntity extends Equatable{
  int? id;
  String? first_name;
  String? last_name;
  String? email;
...
class DashTrackerEntity extends Equatable {
  String? device_id;
  String? protocol;
  String? ip;
  String? sim_no;
...
class DashLinkEntity extends Equatable{
  String? url;
  String? label;
  bool? active;
